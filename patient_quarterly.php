...
$quarter_end_date = '2023-05-25';
$result = pg_query_params($conn, "SELECT * FROM patient WHERE date BETWEEN $1 AND $2", array($quarter_start_date, $quarter_end_date));
...
echo "<center><h1>Quarterly Patient Report</center></h1>";
echo"<center><a href=dashboard.php><h3>GOTO Dashboard</h3></a></center>";

//echo "<table>\n";
echo "<tr><th>Patient ID</th><th>Name</th><th>Admission Date</th><th>Email</th></tr>\n";

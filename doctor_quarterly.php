...
$quarter_end_date = '2023-05-30';
$result = pg_query_params($conn, "SELECT * FROM doctor1 WHERE date BETWEEN $1 AND $2", array($quarter_start_date, $quarter_end_date));
...
echo "<center><h1>Quarterly Doctor Report</center></h1>";
echo"<center><a href=dashboard.php><h3>GOTO  Dashboard</h3></a></center>";

//echo "<table>\n";
echo "<tr><th>Doctor ID</th><th>Name</th><th>Admission Date</th><th>Specialization</th></tr>\n";

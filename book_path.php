...
$email=$_POST['email'];
 ...
 $query = "INSERT INTO book_path (a_id, p_name,email,pno, address, age, blood_grp, date,genter, tt) VALUES ('$a_id','$name','$email','$pno', '$address','$age','$blood_grp','$date','$gender','$tt')";

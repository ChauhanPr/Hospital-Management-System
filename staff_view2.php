...
$name=$_GET['q'];
//echo "Hello<b>".$name;
$res=pg_query($con,"select * from staff where name='$name'");
echo"<html>";
echo"<head>";
echo"<style>
#doctor {
...
echo"<tr><th><b>Staff_Id</b></th><th><b>Name</b></th><th><b>Designation</b></th><th><b>Address</b></th><th><b>Email</b></th><th><b>Duty hour</b></th><th><b>Phone_no.</b></th><th><b>Date</b></th></tr>";
